...
export const metadata = {
  title: 'Design Guard Site',
  description: 'Generated by Design Guard',
};
...
`);
    ...
    for (const screen of screens) {
      ...
      const guardComment = getGuardSignature().replace('<!--', '{/*').replace('-->', '*/}');
      const pageContent = `${guardComment}import type { Metadata } from 'next';
